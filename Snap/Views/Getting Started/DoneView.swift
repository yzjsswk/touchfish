...
struct DoneView: View {
    ...
    var body: some View {
		VStack {
			...
			Spacer()
			Text("You can start using Snap. To activate Snap, hit ⌥ + Space on your keyboard. For configuration options, you can click on the 🔍 Menu Item and then the \"Preferences\" Button.")
				.padding()
